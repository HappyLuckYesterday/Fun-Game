...
/// </summary>
[DataContract]
[DebuggerDisplay("{IdentifierName}")]
public class MoverProperties
{
    ...
    /// <summary>
    /// Gets the mover identifier name.
    /// </summary>
    [DataMember(Name = "dwID")]
    ...
    /// </summary>
    [IgnoreDataMember]
    public ICollection<DropItemProperties> DropItems { get; } = new List<DropItemProperties>();

    /// <summary>
    /// Gets or sets the collection of item kinds the mover can drop.
    /// </summary>
    [IgnoreDataMember]
    public ICollection<DropItemKindProperties> DropItemsKind { get; } = new List<DropItemKindProperties>();
}
