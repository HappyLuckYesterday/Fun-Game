...
namespace Rhisis.Game.Resources.Loaders
{
    public sealed class JobLoader : IGameResourceLoader
    {
        ...
        public void Load()
        {
            var propJobFile = GameResourcesConstants.Paths.JobPropPath;
            var jobsDefinitionFile = GameResourcesConstants.Paths.JobsDefinitionsPath;
            ...
            var jobDefinitionFileContent = File.ReadAllText(jobsDefinitionFile);
