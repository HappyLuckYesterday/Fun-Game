...
{
    public MoverMovedSnapshot(Mover mover, Vector3 beginPosition, Vector3 destinationPosition, float angle, int state, int stateFlag, int motion, int motionEx, int loop, int motionOption, long tickCount)
        : base(SnapshotType.MOVERMOVED, mover.ObjectId)
    {
