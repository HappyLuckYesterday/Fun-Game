...
namespace Rhisis.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20201209081326_Friends")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbAttribute", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbCharacter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbFriend", b =>
                {
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbItemAttributes", b =>
                {
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbItemStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbItemStorageType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbMail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbQuest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbShortcut", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbSkillBuff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbSkillBuffAttribute", b =>
                {
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbCharacter", b =>
                {
                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbUser", "User")
                        .WithMany("Characters")
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbFriend", b =>
                {
                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbCharacter", "Character")
                        .WithMany("Friends")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbCharacter", "Friend")
                        .WithMany()
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbItemAttributes", b =>
                {
                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbAttribute", "Attribute")
                        .WithMany()
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbItem", "Item")
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbItemStorage", b =>
                {
                    ...
                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbItemStorage", "StorageType")
                        .WithMany()
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbMail", b =>
                {
                    ...
                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbCharacter", "Receiver")
                        .WithMany("ReceivedMails")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbCharacter", "Sender")
                        .WithMany("SentMails")
            ...
            modelBuilder.Entity("Rhisis.Infrastructure.Persistance.Entities.DbSkillBuffAttribute", b =>
                {
                    ...
                    b.HasOne("Rhisis.Infrastructure.Persistance.Entities.DbSkillBuff", "SkillBuff")
                        .WithMany("Attributes")
