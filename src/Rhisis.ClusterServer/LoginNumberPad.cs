...
public static class LoginNumberPad
{
    private static readonly int[,] _numericPads =
    {
    ...
    /// <summary>
    /// Gets the correct password by specifying the right numpad id.
    /// </summary>
    /// <param name="idNumPad"></param>
    ...
    public static int GetNumPadToPassword(int idNumPad, int secretNum)
    {
        ...
        if (idNumPad <= 999 && secretNum <= 9999)
        {
            ...
            password = (_numericPads[idNumPad, num1] * 1000) + (_numericPads[idNumPad, num2] * 100) + (_numericPads[idNumPad, num3] * 10) + (_numericPads[idNumPad, num4]);
        }
